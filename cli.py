...
def cli():
    ...
    parser.add_argument('-i', '--input', help='path to your cbz archives/covers(if using --use covers)', type=str , default=r'archives')
    ...
    parser.add_argument('--use', help='use: meta(set), covers(download), zips(download)', type=str, nargs=1)
